...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'service.company' => 'getService_CompanyService',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'inworkflow', 'user' => 'root', 'password' => 'ClearMeaN', 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_7654ab7fa17a8558d4aff075c1d8fe69cc1dae82fc1d08e4a54a30d5afdb7ab7');
    ...
    /**
     * Gets the 'service.company' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Service\Company A AppBundle\Service\Company instance.
     */
    protected function getService_CompanyService()
    {
        return $this->services['service.company'] = new \AppBundle\Service\Company($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addGlobal('base_url', 'http://inworkflow.pp.ua/');
        $instance->addGlobal('base_host', 'inworkflow.pp.ua');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('fvknfkjvneroi4mtr43kmtkl4f');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('587014bdc9d5d4.46336997')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_port' => NULL,
            'database_name' => 'inworkflow',
            'database_user' => 'root',
            'database_password' => 'ClearMeaN',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'secret' => 'fvknfkjvneroi4mtr43kmtkl4f',
            'locale' => 'en',
            ...
            'kernel.secret' => 'fvknfkjvneroi4mtr43kmtkl4f',
